         ...
         @foreach ($formtutor as $tutor)
            ...
            <table width="100%">
                ...
                <tr class="border-bottom border-right" style="background:#353940;color:#FFF;">
                   ...
                   <td width="2%" style="text-align:center;background:#ffffff;color:rgb(0, 0, 0);">{{$tutor->nombres}}</td>
                   
                </tr>
                <tr class="border-bottom border-right" style="background:#353940;color:#FFF;">
                   <td class="pad-center"><strong>Apellido Paterno</strong></td>
                   <td style="text-align:center;background:#ffffff;color:rgb(0, 0, 0);">{{$tutor->apellido_paterno}}</td>
                </tr>
                <tr class="border-bottom border-right" style="background:#353940;color:#FFF;">
                    <td width="2%" class="pad-center"><strong>Apellido Materno</strong></td>
                    <td width="2%"style="text-align:center;background:#ffffff;color:rgb(0, 0, 0);">{{$tutor->apellido_materno}}</td>
                    
                 </tr>
                 <tr class="border-bottom border-right">
                    <td class="pad-center" style="background:#353940;color:#FFF;"><strong>Calle<strong></strong></td>
                    <td style="text-align:center;">{{$tutor->calle}}</td>
                 </tr>
                 <tr class="border-bottom border-right" style="background:#353940;color:#FFF;">
                    <td width="2%" class="pad-center"><strong>Número Interior</strong></td>
                    <td width="2%" style="text-align:center;background:#ffffff;color:rgb(0, 0, 0);">{{$tutor->numero_interior}}</td>
                    
                 </tr>
                 <tr class="border-bottom border-right" style="background:#353940;color:#FFF;">
                    <td class="pad-center"><strong>Número Exterior</strong></td>
                    <td style="text-align:center;background:#ffffff;color:rgb(0, 0, 0);">{{$tutor->numero_exterior}}</td>
                 </tr>
                 <tr class="border-bottom border-right" style="background:#353940;color:#FFF;">
                    <td width="2%" class="pad-center"><strong>Colonia</strong></td>
                    <td width="2%" style="text-align:center;background:#ffffff;color:rgb(0, 0, 0);">{{$tutor->colonia}}</td>
                    
                 </tr>
                 <tr class="border-bottom border-right">
                    <td class="pad-center"style="background:#353940;color:#FFF;"><strong>Ciudad</strong></td>
                    <td style="text-align:center;">{{$tutor->ciudad}}</td>
                 </tr>
                 <tr class="border-bottom border-right" style="background:#353940;color:#FFF;">
                    <td width="2%" class="pad-center"><strong>Estado</strong></td>
                    <td width="2%" style="text-align:center;background:#ffffff;color:rgb(0, 0, 0);">{{$tutor->estado}}</td>
                    
                 </tr>
                 <tr class="border-bottom border-right" style="background:#353940;color:#FFF;">
                    <td class="pad-center"><strong>Código Postal</strong></td>
                    <td style="text-align:center;background:#ffffff;color:rgb(0, 0, 0);">{{$tutor->codigo_postal}}</td>
                 </tr>
                 <tr class="border-bottom border-right" style="background:#353940;color:#FFF;">
                    <td width="2%" class="pad-center"><strong>Curp</strong></td>
                    <td width="2%" style="text-align:center;background:#ffffff;color:rgb(0, 0, 0);">{{$tutor->curp}}</td>
                    
                 </tr>
                 <tr class="border-bottom border-right" style="background:#353940;color:#FFF;">
                    <td class="pad-center"><strong> Fecha de Nacimiento</strong></td>
                    <td width="2%" style="text-align:center;background:#ffffff;color:rgb(0, 0, 0);">{{$tutor->fecha_de_nacimiento}}</td>
                 </tr>
                 <tr class="border-bottom border-right" style="background:#353940;color:#FFF;">
                    <td width="2%" class="pad-center"><strong>Teléfono</strong>
                    <td width="2%" style="text-align:center;background:#ffffff;color:rgb(0, 0, 0);">{{$tutor->telefono}}</td>
                 </tr>
