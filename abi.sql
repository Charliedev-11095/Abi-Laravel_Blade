...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-10-2021 a las 07:40:52
...
--
-- Estructura de tabla para la tabla `intercambiar_altas`
--

CREATE TABLE `intercambiar_altas` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(21, '2021_10_24_224131_create_intercambiar_altas_table', 1);
...
('RaWI2o4tK6XzvXy8Hy31xLGsYmdPbvTbCoCMCxfs', 4, '::1', 'Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.54 Safari/537.36 Edg/95.0.1020.30', '', 1635399476);
...
(1, 'Luis Roberto Garcia Garcia', 'utm190067ti@ut-morelia.edu.mx', NULL, 'Administrador', '$2y$10$TyLU/WNOC.MK3rlsxoVUfOSAs5rypuU5/DReN2E4GcYf3XLHSy4VO', NULL, NULL, NULL, NULL, NULL, '2021-10-28 05:34:29', '2021-10-28 05:34:29'),
(2, 'Hugo Alejandro Zavala Vaca', 'hzavala@pmip.unam.mx', NULL, 'Administrador', '$2y$10$wmwcNhyJ2EbK04.yqrDhmOHxNHaP2Pk3zGkXonW/bzAMTmif.VG9.', NULL, NULL, NULL, NULL, NULL, '2021-10-28 05:35:32', '2021-10-28 05:35:32'),
(3, 'Carlos Rodriguez García', 'utm190026ti@ut-morelia.edu.mx', NULL, 'Administrador', '$2y$10$5qGRZDn3sZzdGi7gMUkzeuEjgy0TsKBh5bUdbLnjZ1HN0/9TopKCm', NULL, NULL, NULL, NULL, NULL, '2021-10-28 05:36:46', '2021-10-28 05:36:46'),
(4, 'Jorge Andres Garcia Garcia', 'georgeutm2014@gmail.com', NULL, 'Administrador', '$2y$10$5Lgdh398aKVchvZmz0PZZeQBCx45R3bVprAxVquqbSdm2GqF9gWJO', NULL, NULL, NULL, NULL, NULL, '2021-10-28 05:37:52', '2021-10-28 05:37:52');
...
--
-- Indices de la tabla `intercambiar_altas`
--
ALTER TABLE `intercambiar_altas`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `intercambiar_altas`
--
ALTER TABLE `intercambiar_altas`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
